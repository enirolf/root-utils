...
if __name__ == "__main__":
    ...
    cmake_string = f"cmake -G Ninja -DCMAKE_CXX_STANDARD=17 -DCMAKE_BUILD_TYPE={args.build_type} -DCMAKE_INSTALL_PREFIX={args.install_dir} {build_opt_string} -Dtesting={args.testing} {args.source_dir}"
